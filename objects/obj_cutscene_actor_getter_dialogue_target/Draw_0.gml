...
// Arrow
draw_sprite_ext(spr_chat_arrow,0,trg.x+9,placey+height*10+2,1,1,0,outlineColor,1);
draw_sprite(spr_chat_arrow,1,trg.x+9,placey+height*10+2);
...
for (i = 0; i < textRows; i += 1) {
	...
	draw_text(placex + 5, placey + 5 + i*10,str[i]);
}
